 ...
 */
?>
<div class="chemistry-homepage-left-column" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
	<?php print $content['left']; ?>
</div>

<div class="chemistry-homepage-right-column" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
